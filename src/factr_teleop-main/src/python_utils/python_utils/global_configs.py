...
sim_desktop_ip_address = "192.168.2.20"
franka_left_ip_address = "192.168.2.20"
franka_right_ip_address = "192.168.2.20"
...
franka_right_real_zmq_addresses = {
    ...
    "force_ext_pub": f"tcp://{franka_right_ip_address}:6009"#右アーム
...
franka_left_real_zmq_addresses = {
    ...
    "force_ext_pub": f"tcp://{franka_left_ip_address}:6010"#左アーム
