...
# # ================================
# save_dir = Path(".")
# csv_path = save_dir / "force_log_left.csv"
# png_path = save_dir / "force_log_left.png"


# # ================================
# # 1) Subscribe
# # ================================
# force_sub = ZMQSubscriber(franka_left_real_zmq_addresses["force_ext_pub"])

# print(f"Listening on: {franka_left_real_zmq_addresses['force_ext_pub']}")
...
#         plt.xlabel("Time [s]")
#         plt.ylabel("Force [N]")
#         plt.title("Franka External Left Force (Zero-Start, Fx/Fy/Fz)")
#         plt.grid()
#         plt.legend()
#         plt.tight_layout()
